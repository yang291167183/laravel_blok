...
<head>
    ...
    <title>微留言演示案例</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('message') }}/msg.css" media="all" />	
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<div class="container">
	  	<div class="qiandaobanner">
		  	<a href="{{ asset('message') }}">
		  		<img src="{{ asset('message') }}/wall.jpg" style="width:100%;" />
		  	</a>
	  	</div>
				...
				<div class="history-date">
					<ul>
						...
						<li class="green bounceInDown nob ly2" style="display:none;">
							<form action="{{ url('/msg/create') }}" method="post" class="form1">
							<dl>
								<dt>
	...
	<script type="text/javascript" src="{{ asset('message') }}/jquery.js"></script>
